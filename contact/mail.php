...
$site_top = "http://seiwa-ind.co.jp";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@seiwa-ind.co.jp";
...
$Referer_check_domain = "seiwa-ind.co.jp";
...
$thanksPage = "http://seiwa-ind.co.jp/contact/thanks.html";
...
$require = array('お名前','フリガナ','メールアドレス','お問い合わせ内容');
...
$refrom_name = "株式会社清和工業";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【株式会社清和工業】お問合せいただきありがとうございました。";
...
〒321-4369
栃木県真岡市熊倉2-19-2
TEL : 0285-83-3838 / FAX : 0285-83-3837
E-mail：info@seiwa-ind.co.jp
------------------------------------------------------------
